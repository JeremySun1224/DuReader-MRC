    ...
    for batch in tqdm(eval_dataloader, desc="Evaluating"):
        ...
        for i, feature_index in enumerate(feature_indices):
            ...
            for log1, log2, log3 in zip(start_logits1, start_logits2, start_logits3):
                start_logits.append(weights[0] * log1 + weights[1] * log2 + weights[2] * log3)

            for log1, log2, log3 in zip(start_logits1, start_logits2, start_logits3):
                end_logits.append(weights[0] * log1 + weights[1] * log2 + weights[2] * log3)
...
def main():
    ...
    model_path1 = "/content/dureader/output/chinese_roberta_wwm_ext_pytorch/DuReader/checkpoint-2000/"
    model_path2 = "/content/dureader/output/chinese_ernie_base/DuReader/checkpoint-2000/"
    model_path3 = "/content/dureader/output/chinese_wwm_ext_pytorch/DuReader/checkpoint-2000/"
