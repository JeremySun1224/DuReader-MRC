    ...
    def _create_examples(self, input_data, set_type):
        ...
        for entry in tqdm(input_data):
            ...
            for paragraph in entry["paragraphs"]:
                ...
                context_text = context_text.replace(u"\u0005", "")
                for qa in paragraph["qas"]:
                    ...
                    if not is_impossible:
                        ...
                        #     doc_tokens = [context_text[:start_position_character], context_text[start_position_character:start_position_character+answer_length], context_text[start_position_character+answer_length:]]
                        #     start_pos = 1
                        #     end_pos = 1
                        ...
                        #     tokenization.whitespace_tokenize(answer_text))
                        #     if actual_text.find(cleaned_answer_text) == -1:
